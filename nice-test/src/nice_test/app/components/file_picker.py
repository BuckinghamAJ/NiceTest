...
class file_picker(ui.dialog):
    def __init__(
        ...
        *,
        ...
        with self, ui.card():
            # Back button to go back a path
            with ui.row().classes('center'):
                ui.button(on_click=self._handle_back).props('icon=arrow_back_ios')
                self.path_label = ui.label(self.path.stem).classes('text-lg')
    ...
    def update_grid(self) -> None:
        ...
        self.path_label.set_text(self.path.stem)
